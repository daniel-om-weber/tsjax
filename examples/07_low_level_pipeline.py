...
valid_ds = grain.MapDataset.source(valid_src).batch(BS, drop_remainder=False).to_iter_dataset()

# -- Test: one full sequence at a time --
test_ds = grain.MapDataset.source(test_src).batch(1, drop_remainder=False).to_iter_dataset()
...
# %%
from tsjax import GrainPipeline  # noqa: E402
